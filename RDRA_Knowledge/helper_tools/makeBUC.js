...
/**
 * ph4UCアクター.tsv を Map<UC名, [{画面, アクター, 入出力要求}]> に変換
 */
 ...
 * 12カラムの出力行を生成する
 */
function makeRow(業務, BUC, アクティビティ, 次, UC, 関連モデル1, 関連オブジェクト1, 関連モデル2, 関連オブジェクト2, 説明, 入出力要求) {
    return [業務, BUC, '', アクティビティ, 次, UC, 関連モデル1, 関連オブジェクト1, 関連モデル2, 関連オブジェクト2, 説明, 入出力要求];
}
